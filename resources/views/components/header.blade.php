    ...
    <div class="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Theme Toggle -->
                @if(config('pertuk.theme', 'system') === 'system')
                <button id="theme-toggle" type="button"
                    ...
                    <!-- Light Icon (Sun) -->
                    <svg class="sun-icon h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    <!-- Dark Icon (Moon) -->
                    <svg class="moon-icon h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                    </svg>
                    <!-- System Icon (Monitor) -->
                    <svg class="monitor-icon h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if(config('pertuk.github_url'))
                    <a href="{{ config('pertuk.github_url') }}" target="_blank" rel="noopener noreferrer"
                        class="rounded-md p-2 text-gray-600 transition-colors hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500/20 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white"
