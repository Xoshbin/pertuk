    ...
    <div class="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="flex items-center gap-8">
                <a href="{{ url('/' . config('pertuk.route_prefix', 'docs')) }}" class="flex items-center gap-3 text-gray-900 dark:text-white transition-colors hover:text-orange-600 dark:hover:text-orange-400">
